class SandraSentinel < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/code-epic/sandra.sentinel/releases/download/v1.0.7/sandra-sentinel-aarch64-apple-darwin"
      sha256 "3ba1c1d8727dd385448f822c0c7344ba1dff496463fc35066b0da73909287bdc"
    elsif Hardware::CPU.intel?
      url "https://github.com/code-epic/sandra.sentinel/releases/download/v1.0.7/sandra-sentinel-x86_64-apple-darwin"
      sha256 "87dcf3f276949ed39476356638b0d138523abfd3915506face29afacee2ed62e"
    end
  end

  on_linux do
    url "https://github.com/code-epic/sandra.sentinel/releases/download/v1.0.7/sandra-sentinel-centos8-x86_64"
